...
import { BOOK_DIRECT, SITE_URL } from "@/lib/guest";

export const metadata: Metadata = {
  title: "Condiciones de reserva",
  description:
    "Disponibilidad, precio y cancelación de AUMARA: lo que muestra el checkout directo para tus fechas es lo que cuenta.",
