...
export default function LegalPage() {
  return <InfoShell eyebrow="Aviso legal · Legal notice" title="AUMARA, clearly identified.">
    ...
    <p>Registered/public contact for the website: Urb. Rincón del Silencio, 3, 03759 Benidoleig, Alicante, Spain · <a href="mailto:elcidspain@gmail.com">elcidspain@gmail.com</a> · <a href="tel:+34622914323">+34 622 914 323</a>.</p>
